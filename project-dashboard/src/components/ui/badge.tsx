  ...
  "inline-flex items-center font-semibold rounded-md justify-center border px-2 py-0.5 w-fit h-fit whitespace-nowrap shrink-0 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-500 text-white hover:bg-green-600 focus-visible:ring-green-500/20 dark:focus-visible:ring-green-500/40",
        failure:
      ...
      size: {
        ...
        lg: "text-md [&>svg]:size-5 px-4 py-1.5",
        xl: "text-lg [&>svg]:size-6 px-5 py-2",
      },
    },
    defaultVariants: {
      variant: "default",
...
function Badge({
  ...
  VariantProps<typeof badgeVariants> & { asChild?: boolean; size?: "sm" | "md" | "lg" | "xl" }) {
